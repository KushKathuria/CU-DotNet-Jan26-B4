...
//var moreThan80 = students.Where(x => x.Marks > 80).ToList();
//foreach (var i in moreThan80)
//{
//    Console.WriteLine(i.Marks);
//}
//var selectedProp = students.Select(x => new { x.Name, x.Marks });
//foreach (var i in selectedProp)
//{
//    Console.WriteLine(i);
//}
//var totalMarks = students.Sum(x => x.Marks);
//Console.WriteLine(totalMarks);

//var studenClass = students.GroupBy(x => x.Class);
//foreach (var i in studenClass)
//{
//    Console.WriteLine(i.Key);
//    foreach (var j in i)
//    {
...
//}
//var studentwithH = students.Where(x => x.Name.Contains("h"));

//foreach (var i in studentwithH)
//{

//    Console.WriteLine(i.Name);
//}
//var avg = students.GroupBy(s => s.Class)
//    .Select(x => new { Class = x.Key, Avg = x.Average(y => y.Marks) });
//foreach (var i in avg)
//{
//    Console.WriteLine(i.Class + "-" + i.Avg);
//}